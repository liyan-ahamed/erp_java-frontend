  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <div className="flex flex-col space-y-2">
        <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Deadlines</h1>
        <p className="text-slate-500 font-medium">View your upcoming deadlines and assignments</p>
      </div>
